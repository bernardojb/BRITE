...
class ValidatorRule {
  constructor(config) {
    ...
    if ("minLength" in cfg) this.minLength = Number(cfg.minLength);

    if ("maxLength" in cfg) this.maxLength = Number(cfg.maxLength);
  }
  ...
  let msg = new EmailContent({
    ...
    html: `
            <div style="color: #A1A2B3; text-decoration: none;">
                ...
                <p style="color: #A1A2B3; text-decoration: none;">Email <a href="mailto:![site]"><strong style="color:"white"> ![site]</strong></a></p>
            </div>
        `,
  });
  try {
