...
const ContactForm = () => {
  const { handleChange, values, handlePress, errors } = useForm(validate);
      ...
      <div className="container">
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 lg:col-span-4 mb-10">
            <h1 className="text-primary max-w-2xl text-xl font-semibold mb-4">
              Faça uma cotação para sua empresa
            </h1>
            <p className="text-secondary max-w-md text-base mb-10">
              Preencha os campos e em breve retornaremos o contato com as
              melhores soluções. Se preferir, entre em contato:
            </p>
          </div>
            ...
            <div className="bg-white shadow-xl w-full rounded-lg">
              <div className="md:p-10 p-6">
                <div className="flex flex-col lg:flex-row mb-4 lg:items-center relative">
                  <label className="text-md text-primary font-bold lg:w-[50%] pr-4">
                    Nome
                  </label>
                  <input
                    className={`text-md text-primary rounded-md border bg-cream border-secondary h-10 ps-2 w-full ${
                      errors.name && "border-validator"
                    }`}
                    type="text"
                    name="name"
                    id="name"
                ...
                <div className="flex flex-col lg:flex-row mb-4">
                  ...
                  <select
                    ...
                    className={`bg-cream rounded-md border border-secondary h-10 ps-2 w-full text-secondary ${
                      errors.service && "border-validator"
                    }`}
                  >
                ...
                <div className="flex flex-col lg:flex-row mb-4">
                  <div className="lg:w-[50%] pr-4">
                    ...
                    <p className="text-xs text-secondary">
                      Quantos computadores você precisa?
                    </p>
                  </div>
                  <select
                    id="computers"
                    ...
                    onChange={handleChange}
                    className={`bg-cream rounded-md border border-secondary h-10 ps-2 w-full text-secondary ${
                      errors.computers && "border-validator"
                    }`}
                  >
                    <option value="" disabled selected hidden>
                ...
                <div className="flex flex-col lg:flex-row mb-4">
                  <div className="lg:w-[50%]">
                    <label className="text-md text-primary font-bold ">
                      Mais alguma coisa?
                    </label>
                  ...
                  <div className="flex flex-col w-full">
                    <textarea
                      ...
                      className={`text-md bg-cream text-primary rounded-md border border-secondary ps-2 pt-1 h-52 mb-4 ${
                        errors.message && "border-validator"
                      }`}
                      name="message"
                      rows="10"
                    ...
                    <p className="text-xs text-secondary mb-4 ">
                      ...
                      <Link
                        ...
                        className="text-primary hover:text-brite font-bold ease-out transition duration-200"
                      >
                    ...
                    >
                      ...
                      <div
                        className={`w-[8px] h-[16px] relative font-semibold`}
                      >
